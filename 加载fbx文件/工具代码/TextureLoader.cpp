	...
	Microsoft::WRL::ComPtr<ID3D12Resource>& textureUploadHeap)
{
	...
	D3D12_RESOURCE_DESC Desc = CD3DX12_RESOURCE_DESC::Buffer(textureUploadBufferSize);
	hr = device->CreateCommittedResource(
		&HeapProperties, // upload heap
		D3D12_HEAP_FLAG_NONE, // no flags
		&Desc, // resource description for a buffer (storing the image data in this heap just to copy to the default heap)
